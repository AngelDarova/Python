class Post:
    def __init__(self, usuario, likes, es_video):
        ...
        self.likes = likes
        self.es_video = es_video #Guarda el valor boolean (True:False)
...
print(f"Hemos cargado {len(feed_instagram)} objetos en el Post en el feed")
...
# supongamos que hay un nuevo post que quiero agregar a la lista:
