...
print("Tu feed actualizada", feed_instagram)

# insert : inserta elemento en la posicion especificada
feed_instagram.insert(2, "PUBLICIDAD_ZAPATILLAS")
print("Tu feed actualizado despues del insert: ", feed_instagram)

# remove() - pop()
feed_instagram.remove("PUBLICIDAD_ZAPATILLAS")
print(feed_instagram)

# a medida que consumimos la feed instagram va  eliminando el primer elemento de la lista
feed_instagram.pop(0)
print("Tu feed actualizada", feed_instagram)

# len() cuenta los elementos de la lista
print(f"te faltan {len(feed_instagram)} publicaciones por ver.")